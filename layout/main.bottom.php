<!-- Other part should come first -->
</ng-view><!-- end ngIf: true -->
</ui-layout>
</div>
</div>
<!---->
...
<et-onetrust-web _ngcontent-ng-c1272297247="" class="ng-tns-c1272297247-0"></et-onetrust-web>
</et-layout-main>
<!---->
<!---->
<!---->
<et-loader _ngcontent-ng-c2907778674="" _nghost-ng-c3382134643="">
    <!---->
</et-loader>
</app-root>
<script id="" text="" charset="" type="text/javascript"
    src="/assets/marketing.etorostatic.com/others/general/js/seo.js"></script>

><style _ngcontent-ng-c1272297247="" id="globalCssVarsStyle" class="ng-tns-c1272297247-0">
    :root {
...
<script type="text/javascript" id="" charset="">
    !(function(a, b) {
        var e =
            "00995ec51eb23fc05a0627b93976ed9179 00444d53aaa69516fdd4f38cb01a408ffb 007bfa109c755ce2abc89bcca6ab1ec76b 00e5c90732d6db4c996b8e51ecf69f2be4 009db2f50602ec66a785ccba2f2190d042 0035680ae49e7216a26be3859972ee9575"
            .split(
                " "
            );
        if (a.obApi)
...
<div id="onetrust-consent-sdk" data-nosnippet="true">
    ...
    <div id="onetrust-pc-sdk" class="otPcCenter ot-hide ot-fade-in" lang="en" aria-label="Preference center"
        ...
        <div role="dialog" aria-modal="true" style="height: 100%" aria-label="Privacy Preference Center">
            ...
            <div class="ot-pc-header">
                <!-- Logo Tag -->
                <div class="ot-pc-logo" role="img" aria-label="Your Privacy">
                    <img alt="Your Privacy"
                        src="/assets/cdn.cookielaw.org/logos/86f58049-00f8-4bcb-9ad9-6c9820d56698/1fe0c9fa-bc98-4c71-afbe-b3921afe5345/7fbb7c02-8920-44b3-9ace-e6102427dd09/1x1.png" />
                </div>
                <button id="close-pc-btn-handler" class="ot-close-icon" aria-label="Close" style="
                background-image: url('/cdn.cookielaw.org/logos/static/ot_close.svg');
              "></button>
            </div>
            <!-- Close Button -->
            <div id="ot-pc-content" class="ot-pc-scrollbar">
                ...
                <div id="ot-pc-desc">
                    ...
                    offer. <br /><a href="/assets/cookiepedia.co.uk/giving-consent-to-cookies"
                ...
                <section class="ot-sdk-row ot-cat-grp">
                    ...
                    <div class="ot-accordion-layout ot-cat-item ot-vs-config" data-optanongroupid="C0001">
                        <button aria-expanded="false" ot-accordion="true" aria-controls="ot-desc-id-C0001"
                            aria-labelledby="ot-header-id-C0001 ot-status-id-C0001"></button>
                        <!-- Accordion header -->
                    ...
                    <div class="ot-accordion-layout ot-cat-item ot-vs-config" data-optanongroupid="C0002">
                        ...
                        <div class="ot-acc-hdr">
                            ...
                            <div class="ot-tgl">
                                <input type="checkbox" name="ot-group-id-C0002" id="ot-group-id-C0002" role="switch"
                                ...
                                <label class="ot-switch" for="ot-group-id-C0002"><span class="ot-switch-nob"></span>
                                    <span class="ot-label-txt">Performance Cookies</span></label>
                            </div>
                        </div>
                        <!-- accordion detail -->
                        <div class="ot-acc-grpcntr ot-acc-txt">
                            <p class="ot-acc-grpdesc ot-category-desc" id="ot-desc-id-C0002">
                    ...
                    <div class="ot-accordion-layout ot-cat-item ot-vs-config" data-optanongroupid="C0003">
                        ...
                        <div class="ot-acc-hdr">
                            ...
                            <div class="ot-tgl">
                                <input type="checkbox" name="ot-group-id-C0003" id="ot-group-id-C0003" role="switch"
                    ...
                    <div class="ot-accordion-layout ot-cat-item ot-vs-config" data-optanongroupid="C0004">
                        ...
                        <div class="ot-acc-hdr">
                            ...
                            <div class="ot-tgl">
                                <input type="checkbox" name="ot-group-id-C0004" id="ot-group-id-C0004" role="switch"
                                ...
                                <label class="ot-switch" for="ot-group-id-C0004"><span class="ot-switch-nob"></span>
                                    <span class="ot-label-txt">Targeting Cookies</span></label>
                            </div>
                        </div>
                        <!-- accordion detail -->
                        <div class="ot-acc-grpcntr ot-acc-txt">
                    ...
                    <div class="ot-lst-subhdr">
                        <div class="ot-search-cntr">
                            ...
                            <input id="vendor-search-handler" type="text" name="vendor-search-handler"
                                placeholder="Search…" aria-label="Cookie list search" />
    ...
    C402.765,25.895,404.093,19.231,400.858,11.427z"></path>
            ...
            <div class="ot-pc-footer ot-pc-scrollbar">
                ...
                <div class="ot-pc-footer-logo">
                    <a href="/assets/www.onetrust.com/products/cookie-consent/" target="_blank"
                        rel="noopener noreferrer" aria-label="Powered by OneTrust Opens in a new Tab"><img
                            alt="Powered by Onetrust"
                            src="/assets/cdn.cookielaw.org/logos/static/powered_by_logo.svg"
    ...
    <div id="ot-sdk-btn-floating" class="ot-floating-button" data-title="Cookie Preferences">
        <div class="ot-floating-button__front custom-persistent-icon">
            <button type="button" class="ot-floating-button__open" aria-label="Open Preferences"></button>
        </div>
        <div class="ot-floating-button__back custom-persistent-icon">
            <button type="button" class="ot-floating-button__close" aria-label="Close Preferences"
